(function exposeAdminTemplates(root) {
  const templates = {
    'products.html': `
      ...
      <div class="modal-backdrop" id="productModal" style="display:none"><div class="modal modal-wide"><div class="modal-header"><div><p class="module-kicker">HỒ SƠ SẢN PHẨM</p><h3 id="productModalTitle">Thêm sản phẩm</h3></div><button class="close-btn" onclick="closeProductModal()">×</button></div><div class="modal-body"><form id="productForm"><div class="form-grid">
        <div class="form-group"><label>Mã sản phẩm *</label><input id="productCode" maxlength="20" required></div><div class="form-group"><label>Danh mục *</label><select id="productCategoryInput" required></select></div>
        <div class="form-group form-span-2"><label>Tên sản phẩm *</label><input id="productName" maxlength="150" required></div>
        <div class="form-group"><label>Đơn vị tính *</label><input id="productUnit" maxlength="30" required placeholder="Hộp, chai, gói..."></div><div class="form-group"><label>Mã vạch</label><input id="productBarcode" maxlength="30" placeholder="Có thể bổ sung sau"></div>
        <div class="form-group"><label>Giá nhập *</label><input id="productCost" type="number" min="0" step="100" required></div><div class="form-group"><label>Giá bán *</label><input id="productPrice" type="number" min="0" step="100" required></div>
        <div class="form-group"><label>Tồn tối thiểu *</label><input id="productMinimum" type="number" min="0" step="1" required></div><div class="form-group"><label>Trạng thái</label><select id="productStatusInput"><option>Đang bán</option><option>Ngừng bán</option></select></div>
      </div><div class="modal-footer"><button type="button" class="btn btn-secondary" onclick="closeProductModal()">Hủy</button><button class="btn btn-primary" type="submit">Lưu sản phẩm</button></div></form></div></div></div>
