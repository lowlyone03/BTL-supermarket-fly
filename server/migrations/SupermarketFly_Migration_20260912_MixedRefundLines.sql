/* Dòng hoàn đa kênh: GiaoDichHoan có MaHD + PhuongThuc; ZaloPay fields nullable.
   ...
   UX_GiaoDichHoan_MRefundId từ ZaloPayRefund là UNIQUE CONSTRAINT — DROP INDEX bị cấm. */
...
IF OBJECT_ID(N'dbo.GiaoDichHoan', N'U') IS NOT NULL
   AND EXISTS (
        ...
        WHERE object_id = OBJECT_ID(N'dbo.GiaoDichHoan')
          AND name = N'ZpTransIdGoc'
          AND is_nullable = 0
   )
