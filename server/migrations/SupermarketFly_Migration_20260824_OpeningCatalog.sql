...
BEGIN TRY
    ...
    */
    ...
    VALUES
        ('SUA001','DM_SUA',N'Sữa tươi tiệt trùng Vinamilk không đường 1 L',N'Hộp',30000,86000,12),
        ('SUA002','DM_SUA',N'Sữa tươi tiệt trùng TH true MILK có đường 1 L',N'Hộp',30000,86000,12),
        ('SUA003','DM_SUA',N'Sữa tươi tiệt trùng Dutch Lady 1 L',N'Hộp',32000,88000,12),
        ('SUA004','DM_SUA',N'Sữa chua Vinamilk có đường lốc 4 hộp',N'Lốc',25000,82000,16),
        ('SUA005','DM_SUA',N'Sữa chua uống Probi lốc 5 chai',N'Lốc',26000,83000,10),
        ('SUA006','DM_SUA',N'Sữa đặc Ông Thọ 380 g',N'Lon',30000,88000,10),

        ('BK001','DM_BK',N'Bánh quy Cosy Marie 300 g',N'Gói',17000,72000,12),
        ('BK002','DM_BK',N'Bánh Chocopie Orion hộp 12 cái',N'Hộp',28000,85000,10),
        ('BK003','DM_BK',N'Bánh AFC dinh dưỡng hộp 300 g',N'Hộp',30000,88000,10),
        ('BK004','DM_BK',N'Kẹo sô-cô-la M&M 100 g',N'Gói',52000,115000,8),
        ('BK005','DM_BK',N'Kẹo Mentos cuộn 37,5 g',N'Cuộn',7000,60000,20),
        ('BK006','DM_BK',N'Bánh gạo One One 150 g',N'Gói',25000,82000,12),

        ('NGK001','DM_NGK',N'Nước tinh khiết Lavie 500 ml',N'Chai',4500,56000,24),
        ('NGK002','DM_NGK',N'Nước ngọt Coca-Cola 330 ml',N'Lon',10000,63000,24),
        ('NGK003','DM_NGK',N'Nước ngọt Pepsi 330 ml',N'Lon',9000,62000,24),
        ('NGK004','DM_NGK',N'Nước cam có ga Mirinda 330 ml',N'Lon',9000,62000,18),
        ('NGK005','DM_NGK',N'Trà xanh Không Độ 455 ml',N'Chai',9000,62000,18),
        ('NGK006','DM_NGK',N'Trà Ô Long Tea Plus 455 ml',N'Chai',10000,63000,18),

        ('HMP001','DM_HMP',N'Nước rửa chén Sunlight chanh 750 g',N'Chai',32000,92000,10),
        ('HMP002','DM_HMP',N'Nước giặt Ariel 3,2 kg',N'Túi',142000,229000,8),
        ('HMP003','DM_HMP',N'Nước giặt OMO Matic 3,1 kg',N'Túi',125000,209000,8),
        ('HMP004','DM_HMP',N'Dầu gội Clear Men 630 g',N'Chai',168000,255000,6),
        ('HMP005','DM_HMP',N'Dầu gội Sunsilk mềm mượt 650 g',N'Chai',150000,235000,6),
        ('HMP006','DM_HMP',N'Kem đánh răng P/S bảo vệ 123 180 g',N'Tuýp',26000,84000,12),

        ('DH001','DM_DH',N'Cá ngừ ngâm dầu đóng hộp 170 g',N'Hộp',22000,79000,10),
        ('DH002','DM_DH',N'Cá hộp sốt cà 155 g',N'Hộp',20000,77000,10),
        ('DH003','DM_DH',N'Thịt heo hầm đóng hộp 150 g',N'Hộp',25000,83000,10),
        ('DH004','DM_DH',N'Thịt hộp Spam 340 g',N'Hộp',80000,149000,6),
        ('DH005','DM_DH',N'Đậu Hà Lan đóng hộp 400 g',N'Hộp',28000,86000,8),
        ('DH006','DM_DH',N'Ngô ngọt đóng hộp 425 g',N'Hộp',52000,115000,8),

        ('GD001','DM_GD',N'Giấy vệ sinh Pulppy 10 cuộn',N'Bịch',65000,129000,8),
        ('GD002','DM_GD',N'Khăn giấy ăn Bless You hộp 180 tờ',N'Hộp',22000,79000,10),
        ('GD003','DM_GD',N'Túi rác tự hủy cỡ trung',N'Cuộn',35000,95000,10),
        ('GD004','DM_GD',N'Miếng rửa chén Scotch-Brite gói 3 miếng',N'Gói',25000,82000,10),
        ('GD005','DM_GD',N'Màng bọc thực phẩm 30 cm x 30 m',N'Cuộn',30000,89000,8),
        ('GD006','DM_GD',N'Hộp đựng thực phẩm nhựa 1 L',N'Cái',18000,75000,8);
