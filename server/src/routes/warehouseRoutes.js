...
router.get('/reports/written-off', requirePermission('UC15'), reportController.getWrittenOffGoodsReport);
router.post('/reports/submit', requirePermission('UC15'), reportController.submitWarehouseReport);
router.get('/reports/submissions', requirePermission('UC15'), reportController.listMyWarehouseReports);
router.delete('/reports/submissions/:id', requirePermission('UC15'), reportController.withdrawWarehouseReport);
...
router.get('/stock-issues/pending-sources', requirePermission('UC19'), stockIssueController.getPendingSources);
router.get('/stock-issues/from-count/:id', requirePermission('UC19'), stockIssueController.previewFromCount);
router.get('/stock-issues/from-return/:id', requirePermission('UC19'), stockIssueController.previewFromReturn);
