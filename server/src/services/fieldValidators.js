...
const CASH_AMOUNT_LIMIT = 1_000_000_000;
...
module.exports = {
    ...
    validateOptionalVnTaxId,
    validateOptionalBhxh,
    validateOptionalBankAccount,
    validateOptionalMaritalStatus,
    validateOptionalCccd,
    ...
    validateOptionalPastDate,
    toIsoDate,
    validateOptionalText,
    validateRequiredVnPhone,
    validateRequiredCccd,
    validateRequiredGender,
    validateRequiredPastDate,
    validateAllowedOption,
    validateEmployeeProfileFields,
